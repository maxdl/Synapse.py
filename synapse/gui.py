...
class MainFrame ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.LateralDistCheckBox = wx.CheckBox( self.AnalysisOptionsTab, wx.ID_ANY, u"Distance along postsynaptic membrane", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.LateralDistCheckBox.SetToolTipString( u"Lateral distance along postsynaptic membrane between the projections of the points on the membrane" )
